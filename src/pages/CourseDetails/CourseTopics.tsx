...
export default function CourseTopics({data}:WhatGetSPFProps) {
  return (
    ...
    <Typography style={{color:'black',fontSize:'28px',fontWeight:'400',textAlign:'start',textTransform:'uppercase',marginBottom:'50px'}}>
       ...
       Topics</Typography>
       {
        data.map((item,_index)=>(
          ...
          <Typography style={{color:'black',fontSize:'16px',textAlign:'start',marginLeft:'70px',lineHeight:'40px', display:"flex",alignItems:'center'}}>
