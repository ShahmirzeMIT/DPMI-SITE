...
export default function CertificationDetails() {
    ...
    return (
        <Box sx={{}}>
            <Box sx={{ marginTop: '120px', color: 'gray',maxWidth:'1280px',margin:'0 auto' }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-around', width: '100%', margin: '40px auto',flexWrap:'wrap',gap:'60px' }}>
