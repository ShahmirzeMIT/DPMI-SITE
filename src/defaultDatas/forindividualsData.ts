export const allForIndividuals=[
   { 
   ...
   },
   {
    ...
    title:"Become an AI Foundation Practitioner",
    text:"Learn the essential tools and strategies to launch and manage a successful startup.",
   },
   {
    id:'/certificates/1004',
    title:"Become a Startup Foundation Practitioner",
    text:"Learn the essential tools and strategies to launch and manage a successful startup.",
   },
   {
    id:'/certificates/1002',
    title:"Become an Agile Communication Profesional Practitioner ",
